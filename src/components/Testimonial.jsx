...
export default function Testimonial() {
    ...
    return (
        <section className="flex flex-col justify-center items-center py-16 pb-26 bg-white relative">
            <h2 className="text-3xl font-semibold mb-10 text-left">What Our Customers Say</h2>
            ...
            <div
                ref={scrollRef}
                className="flex space-x-6 py-9 overflow-x-auto px-6 w-full max-w-6xl scrollbar-hide scroll-smooth"
            >
